<script lang="ts">
	...
	import AccordionCV from '$lib/components/cv/AccordionCV.svelte';
	import Timeline from '$lib/components/cv/Timeline.svelte';
	import { education, certifications, projects } from '$lib/data/experience';
	import { skills, skillCategories, getSkillsByCategory, getSkillUrl } from '$lib/data/skills';
	import { languages } from '$lib/data/languages';

	let viewMode = $state<'accordion' | 'classic'>('accordion');
</script>

<svelte:head>
	<title>CV - Ivan Kokalovic</title>
	<meta name="description" content="Curriculum Vitae of Ivan Kokalović - Backend Developer & Infrastructure Engineer" />
</svelte:head>
	...
	{:else}
		...
		<section class="cv-hero">
			<div class="hero-content">
				...
				<p class="page-subtitle">
					Click on any experience to see detailed responsibilities, achievements, and skills utilized
				</p>
		...
		<section class="cv-section">
			<div class="section-header">
				...
				<span class="section-subtitle">7+ years of professional journey</span>
			</div>
			<Timeline />
		</section>
		...
		<section class="cv-section">
			<div class="section-header">
				...
				<span class="section-subtitle">Click to view related projects</span>
			</div>
