...
# Skills
**Backend & Infrastructure:** Java, Terragrunt, Terraform, Docker, REST APIs

**Programming Languages:** Python, Bash, PowerShell, JavaScript, C++, SQL

**DevOps & Monitoring:** Graylog, Grafana, Docker, Linux, SoftEther

**Technologies & Tools:** Jira, Confluence, MySQL, OCR (Tesseract), Lambda Functions, HOCON

**Systems & Methodologies:** IAM, SLA Management, AML Systems, Fraud Prevention, Technical Support

**Soft Skills:** Creative Problem Solving, Project Management, Technical Documentation
